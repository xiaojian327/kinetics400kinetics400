        ...
        if os.path.isdir(folder_path):
            ...
            for file in os.listdir(folder_path):
                ...
                if file.endswith(".mp4"):
                    # 构建视频文件路径和标签
                    video_file = os.path.join( file) #folder_path,
                    video_files.append(f"{video_file} {label}")
...
# 示例用法
video_folder = "F:/kinetics/kinetics-dataset/k400/data/val"  # 替换为你的视频文件夹路径
output_file = "F:/kinetics/kinetics-dataset/k400/data/val1111.txt"  # 输出注释文件的路径
